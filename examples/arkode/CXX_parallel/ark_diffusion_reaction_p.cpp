...
public:
  ...
  realtype total() const { return total_; }
...
static int CVodeInnerStepper_Evolve(MRIStepInnerStepper stepper, realtype t0,
                                    realtype tout, N_Vector y);
static int CVodeInnerStepper_FullRhs(MRIStepInnerStepper stepper, realtype t,
                                     N_Vector y, N_Vector f, int mode);
static int CVodeInnerStepper_Reset(MRIStepInnerStepper stepper, realtype tR,
                                   N_Vector yR);
...
static int PSolve(realtype t, N_Vector u, N_Vector f, N_Vector r, N_Vector z,
