...
static void ProcessArgs(int argc, char* argv[], int my_pe, booleantype* sensi,
...
static void BSend(MPI_Comm comm, int my_pe, int isubx, int isuby,
                  sunindextype dsizex, sunindextype dsizey, realtype udata[]);
...
static void PrintOutput(void* cvode_mem, int my_pe, MPI_Comm comm, realtype t,
                        N_Vector u);
