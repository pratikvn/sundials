...
static int Precond(realtype tt, N_Vector cc, N_Vector cp, N_Vector rr,
                   realtype cj, void* user_data);

static int PSolve(realtype tt, N_Vector cc, N_Vector cp, N_Vector rr,
...
static int PSolve(realtype tt, N_Vector cc, N_Vector cp, N_Vector rr,
                  N_Vector rvec, N_Vector zvec, realtype cj, realtype dalta,
                  void* user_data)
{
  realtype **Pxy, *zxy;
  sunindextype* pivot;
