...
static int JacB(realtype tt, realtype cjB, N_Vector yy, N_Vector yp,
                N_Vector yyB, N_Vector ypB, N_Vector rrB, SUNMatrix JB,
                void* user_data, N_Vector tmp1B, N_Vector tmp2B, N_Vector tmp3B);

static int rhsQB(realtype tt, N_Vector yy, N_Vector yp, N_Vector yyB,
...
static int JacB(realtype tt, realtype cj, N_Vector yy, N_Vector yp,
                N_Vector yyB, N_Vector ypB, N_Vector rrB, SUNMatrix JB,
                void* user_data, N_Vector tmp1B, N_Vector tmp2B, N_Vector tmp3B)
{
  realtype y2, y3;
