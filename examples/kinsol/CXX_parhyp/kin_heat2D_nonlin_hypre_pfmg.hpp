...
static int PSolve(void* user_data, N_Vector r, N_Vector z, realtype tol, int lr);
...
// c(u) = u
realtype c1(realtype u_val) { return u_val; }

// c(u) = u^3 - u
realtype c2(realtype u_val) { return u_val * u_val * u_val - u_val; }

// c(u) = u - u^2
realtype c3(realtype u_val) { return u_val - u_val * u_val; }

// c(u) = e^u
realtype c4(realtype u_val) { return exp(u_val); }

// c(u) = u^4
realtype c5(realtype u_val) { return u_val * u_val * u_val * u_val; }
