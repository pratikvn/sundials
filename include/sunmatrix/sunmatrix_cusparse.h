...
SUNDIALS_EXPORT SUNErrCode SUNMatrix_cuSparse_SparseType(SUNMatrix A);
SUNDIALS_EXPORT SUNErrCode SUNMatrix_cuSparse_Rows(SUNMatrix A);
SUNDIALS_EXPORT SUNErrCode SUNMatrix_cuSparse_Columns(SUNMatrix A);
SUNDIALS_EXPORT SUNErrCode SUNMatrix_cuSparse_NNZ(SUNMatrix A);
...
SUNDIALS_EXPORT SUNErrCode SUNMatrix_cuSparse_NumBlocks(SUNMatrix A);
SUNDIALS_EXPORT SUNErrCode SUNMatrix_cuSparse_BlockRows(SUNMatrix A);
SUNDIALS_EXPORT SUNErrCode SUNMatrix_cuSparse_BlockColumns(SUNMatrix A);
SUNDIALS_EXPORT SUNErrCode SUNMatrix_cuSparse_BlockNNZ(SUNMatrix A);
