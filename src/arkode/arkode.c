...
/*---------------------------------------------------------------
  ...
  *StepCreate.
  ...
  ---------------------------------------------------------------*/
int arkResize(ARKodeMem ark_mem, N_Vector y0, sunrealtype hscale, sunrealtype t0,
...
/*---------------------------------------------------------------
  ...
  *StepSetStopTime function), in which case if a solver step
  ...
  ---------------------------------------------------------------*/
int arkEvolve(ARKodeMem ark_mem, sunrealtype tout, N_Vector yout, sunrealtype* tret,
              int itask)
{
  SUNAssignSUNCTX(ark_mem->sunctx);
...
int arkEwtSetSmallReal(N_Vector ycur, N_Vector weight, void* arkode_mem)
{
  ...
  SUNCheckCallLastErrNoRet(N_VConst(SUN_SMALL_REAL, weight));
  return (ARK_SUCCESS);
}
...
/*---------------------------------------------------------------
  ...
  ---------------------------------------------------------------*/
int arkPredict_Bootstrap(ARKodeMem ark_mem, sunrealtype hj, sunrealtype tau, int nvec,
                         sunrealtype* cvals, N_Vector* Xvecs, N_Vector yguess)
{
  SUNAssignSUNCTX(ark_mem->sunctx);
...
int arkCheckConstraints(ARKodeMem ark_mem, int* constrfails, int* nflag)
{
  ...
  ark_mem->eta = SUN_RCONST(0.9) * ark_mem->eta;
