                  ...
                  long int* ml, sunrealtype* dqrely, int* ier)
{
  ...
  *ier = ARKBBDPrecInit(ARK_arkodemem, (sunindextype)(*Nloc),
                        (sunindextype)(*mudq), (sunindextype)(*mldq),
                        (sunindextype)(*mu), (sunindextype)(*ml), *dqrely,
                        (ARKLocalFn)FARKgloc, (ARKCommFn)FARKcfn);
  return;
}
             ...
             void* user_data)
{
  ...
  FARK_GLOCFN(&Nloc, &t, yloc_data, gloc_data, ARK_userdata->ipar,
...
int FARKcfn(long int Nloc, sunrealtype t, N_Vector y, void* user_data)
{
  ...
  ARK_userdata = (FARKUserData)user_data;
  FARK_COMMFN(&Nloc, &t, yloc, ARK_userdata->ipar, ARK_userdata->rpar, &ier);
  return (ier);
}
...
void FARK_BBDOPT(long int* lenrwbbd, long int* leniwbbd, long int* ngebbd)
{
