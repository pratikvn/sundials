...
extern void FIDA_DJAC(long int* N, realtype* T, realtype* Y, realtype* YP,
                      realtype* R, realtype* J, realtype* CJ, realtype* EWT,
                 ...
                 N_Vector vtemp2, N_Vector vtemp3)
{
  ...
  FIDA_DJAC(&N, &t, yy_data, yp_data, rr_data, jacdata, &c_j, ewtdata, &h,
            IDA_userdata->ipar, IDA_userdata->rpar, v1data, v2data, v3data, &ier);
