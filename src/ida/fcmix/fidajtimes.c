                ...
                void* user_data)
{
  ...
  FIDA_JTSETUP(&t, ydata, ypdata, rdata, &cj, ewtdata, &h, IDA_userdata->ipar,
               ...
               N_Vector vtemp2)
{
  ...
  /* Call user-supplied routine */
  FIDA_JTIMES(&t, yy_data, yp_data, rr_data, vdata, Jvdata, &c_j, ewtdata, &h,
              IDA_userdata->ipar, IDA_userdata->rpar, v1data, v2data, &ier);
