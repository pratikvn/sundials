...
static void VScaleSum_OpenMPDEV(realtype c, N_Vector x, N_Vector y,
                                N_Vector z); /* z=c(x+y)  */
static void VScaleDiff_OpenMPDEV(realtype c, N_Vector x, N_Vector y,
                                 N_Vector z); /* z=c(x-y)  */
static void VLin1_OpenMPDEV(realtype a, N_Vector x, N_Vector y,
                            N_Vector z); /* z=ax+y    */
static void VLin2_OpenMPDEV(realtype a, N_Vector x, N_Vector y,
                            N_Vector z);                         /* z=ax-y    */
...
static int VDiffVectorArray_OpenMPDEV(int nvec, N_Vector* X, N_Vector* Y,
                                      N_Vector* Z); /* Z=X-Y     */
static int VScaleSumVectorArray_OpenMPDEV(int nvec, realtype c, N_Vector* X,
                                          N_Vector* Y, N_Vector* Z); /* Z=c(X+Y)  */
static int VScaleDiffVectorArray_OpenMPDEV(int nvec, realtype c, N_Vector* X,
                                           N_Vector* Y,
                                           N_Vector* Z); /* Z=c(X-Y)  */
static int VLin1VectorArray_OpenMPDEV(int nvec, realtype a, N_Vector* X,
                                      N_Vector* Y, N_Vector* Z); /* Z=aX+Y    */
static int VLin2VectorArray_OpenMPDEV(int nvec, realtype a, N_Vector* X,
                                      N_Vector* Y, N_Vector* Z); /* Z=aX-Y    */
static int VaxpyVectorArray_OpenMPDEV(int nvec, realtype a, N_Vector* X,
                                      N_Vector* Y); /* Y <- aX+Y */
...
void N_VCopyToDevice_OpenMPDEV(N_Vector x)
{
  ...
  omp_target_memcpy(dev_ptr, host_ptr, sizeof(realtype) * length, 0, 0, dev,
                    host);
...
void N_VCopyFromDevice_OpenMPDEV(N_Vector x)
{
  ...
  omp_target_memcpy(host_ptr, dev_ptr, sizeof(realtype) * length, 0, 0, host,
                    dev);
...
void N_VLinearSum_OpenMPDEV(realtype a, N_Vector x, realtype b, N_Vector y,
                            N_Vector z)
{
  sunindextype i, N;
...
int N_VScaleAddMulti_OpenMPDEV(int nvec, realtype* a, N_Vector x, N_Vector* Y,
                               N_Vector* Z)
{
  int i, dev;
  sunindextype j, N;
...
int N_VLinearSumVectorArray_OpenMPDEV(int nvec, realtype a, N_Vector* X,
...
int N_VLinearCombinationVectorArray_OpenMPDEV(int nvec, int nsum, realtype* c,
