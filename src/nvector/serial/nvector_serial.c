...
static void VScaleSum_Serial(realtype c, N_Vector x, N_Vector y,
                             N_Vector z); /* z=c(x+y)  */
static void VScaleDiff_Serial(realtype c, N_Vector x, N_Vector y,
                              N_Vector z); /* z=c(x-y)  */
static void VLin1_Serial(realtype a, N_Vector x, N_Vector y,
                         N_Vector z); /* z=ax+y    */
static void VLin2_Serial(realtype a, N_Vector x, N_Vector y,
                         N_Vector z);                         /* z=ax-y    */
...
static void VDiffVectorArray_Serial(int nvec, N_Vector* X, N_Vector* Y,
                                    N_Vector* Z); /* Z=X-Y     */
static void VScaleSumVectorArray_Serial(int nvec, realtype c, N_Vector* X,
                                        N_Vector* Y, N_Vector* Z); /* Z=c(X+Y)  */
static void VScaleDiffVectorArray_Serial(int nvec, realtype c, N_Vector* X,
                                         N_Vector* Y, N_Vector* Z); /* Z=c(X-Y)  */
static void VLin1VectorArray_Serial(int nvec, realtype a, N_Vector* X,
                                    N_Vector* Y, N_Vector* Z); /* Z=aX+Y    */
static void VLin2VectorArray_Serial(int nvec, realtype a, N_Vector* X,
                                    N_Vector* Y, N_Vector* Z); /* Z=aX-Y    */
static void VaxpyVectorArray_Serial(int nvec, realtype a, N_Vector* X,
                                    N_Vector* Y); /* Y <- aX+Y */
...
SUNErrCode N_VLinearCombination_Serial(int nvec, realtype* c, N_Vector* X,
                                       N_Vector z)
{
