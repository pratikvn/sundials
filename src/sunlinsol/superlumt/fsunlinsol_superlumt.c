...
void FSUNSUPERLUMT_INIT(int* code, int* num_threads, int* ier)
{
  *ier = 0;
  ...
  case FCMIX_CVODE:
    ...
    F2C_CVODE_linsol = SUNLinSol_SuperLUMT(F2C_CVODE_vec, F2C_CVODE_matrix,
                                           *num_threads);
  ...
  case FCMIX_IDA:
    ...
    F2C_IDA_linsol = NULL;
    F2C_IDA_linsol = SUNLinSol_SuperLUMT(F2C_IDA_vec, F2C_IDA_matrix,
                                         *num_threads);
  ...
  case FCMIX_KINSOL:
    ...
    F2C_KINSOL_linsol = SUNLinSol_SuperLUMT(F2C_KINSOL_vec, F2C_KINSOL_matrix,
                                            *num_threads);
  ...
  case FCMIX_ARKODE:
    ...
    F2C_ARKODE_linsol = SUNLinSol_SuperLUMT(F2C_ARKODE_vec, F2C_ARKODE_matrix,
                                            *num_threads);
...
void FSUNMASSSUPERLUMT_INIT(int* num_threads, int* ier)
{
  *ier = 0;
  ...
  F2C_ARKODE_mass_sol =
    SUNLinSol_SuperLUMT(F2C_ARKODE_vec, F2C_ARKODE_mass_matrix, *num_threads);
...
{
  *ier = 0;
  *ier = SUNLinSol_SuperLUMTSetOrdering(F2C_ARKODE_mass_sol, *ordering_choice);
}
