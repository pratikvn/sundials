...
void FSUNBANDMAT_INIT(int* code, long int* N, long int* mu, long int* ml, int* ier)
{
  *ier = 0;
  ...
  case FCMIX_CVODE:
    ...
    F2C_CVODE_matrix = SUNBandMatrix((sunindextype)(*N), (sunindextype)(*mu),
                                     (sunindextype)(*ml));
  ...
  case FCMIX_IDA:
    ...
    F2C_IDA_matrix = NULL;
    F2C_IDA_matrix = SUNBandMatrix((sunindextype)(*N), (sunindextype)(*mu),
                                   (sunindextype)(*ml));
  ...
  case FCMIX_KINSOL:
    ...
    F2C_KINSOL_matrix = SUNBandMatrix((sunindextype)(*N), (sunindextype)(*mu),
                                      (sunindextype)(*ml));
  ...
  case FCMIX_ARKODE:
    ...
    F2C_ARKODE_matrix = SUNBandMatrix((sunindextype)(*N), (sunindextype)(*mu),
                                      (sunindextype)(*ml));
...
void FSUNBANDMASSMAT_INIT(long int* N, long int* mu, long int* ml, int* ier)
{
  *ier = 0;
  ...
  F2C_ARKODE_mass_matrix =
    SUNBandMatrix((sunindextype)(*N), (sunindextype)(*mu), (sunindextype)(*ml));
