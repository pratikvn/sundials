...
void FSUNDENSEMASSMAT_INIT(long int* M, long int* N, int* ier)
{
  *ier = 0;
  ...
  F2C_ARKODE_mass_matrix = SUNDenseMatrix((sunindextype)(*M), (sunindextype)(*N));
